...
public class ModField extends HorizontalFieldManager {
	...
	private ModPost post;
	
	public ModField(ModPost post) {
		super(FOCUSABLE);
		this.post = post;
		...
		LabelField text = new LabelField(post.text,Field.FOCUSABLE) {
			public void paint(Graphics g) {
