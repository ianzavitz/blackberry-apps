...
public class TodoItem implements Persistable {
	...
	public TodoItem(String pTitle, String pDesc) {
		title = pTitle;
		description = pDesc;
		checked = false;
		color = "White";
	...
	public TodoItem(String pTitle, String pDesc, String c) {
		title = pTitle;
		description = pDesc;
		checked = false;
		color = c;
	...
	public TodoItem(String pTitle, String pDesc, String c, Date d) {
		title = pTitle;
		description = pDesc;
		checked = false;
		color = c;
	...
	public TodoItem(String pTitle, String pDesc, boolean flag) {
		title = pTitle;
		description = pDesc;
		checked = flag;
		color = "White";
	...
	public TodoItem(String pTitle, String pDesc, boolean flag, String c) {
		title = pTitle;
		description = pDesc;
		checked = flag;
		color = c;
